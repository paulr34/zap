...
-- Adjusting the ENDPOINT_COMPOSITION table to include a primary key
...
-- New junction table to manage the many-to-many relationship
CREATE TABLE IF NOT EXISTS "DEVICE_COMPOSITION" (
  "DEVICE_ID" integer,
  "COMPOSITION_ID" integer,
  FOREIGN KEY ("DEVICE_ID") REFERENCES "DEVICE"("DEVICE_ID") ON DELETE CASCADE,
  FOREIGN KEY ("COMPOSITION_ID") REFERENCES "ENDPOINT_COMPOSITION"("COMPOSITION_ID") ON DELETE CASCADE
);
